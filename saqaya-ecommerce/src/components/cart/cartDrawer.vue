<template>
  <div>
    ...
    <div class="drawer" :class="{ open: visible }" @click.stop>
      ...
      <h2>Cart</h2>
      <button class="drawer__header--clear" @click="clearCart()" v-if="cart.length>0"><svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="25" height="25" viewBox="0 0 94 94">
...
.drawer__header--clear svg {
  stroke: rgb(174, 204, 220);
  stroke-width: 3px;  
  &:hover{
    cursor: pointer;
  }
